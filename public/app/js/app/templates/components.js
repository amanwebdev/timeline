...
System.register(['./task.component', './task-list.component', './history.component', './login-form.component', './signup-form.component', './theme-chooser.component.ts'], function(exports_1, context_1) {
    "use strict";
    ...
    return {
        setters:[
            ...
            function (theme_chooser_component_ts_1_1) {
                exportStar_1(theme_chooser_component_ts_1_1);
            }],
        execute: function() {
        }
    }
